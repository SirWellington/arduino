/**
 * This Device is a Night Lamp that lights brightly
...
void loop() 
{
  ...
  redOutput = map(redInput, 0, 1023, 255, 0);
  blueOutput = map(blueInput, 0, 1023, 255, 0);
  greenOutput = map(greenInput, 0, 1023, 255, 0);
